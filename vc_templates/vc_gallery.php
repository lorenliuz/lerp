...
?>
<div<?php if ( $type === 'isotope' || $type === 'justified' ) echo ' id="' . esc_attr($el_id) . '"'; ?>
                    ...
                    <div class="menu-horizontal<?php if ( $filtering_full_width !== 'yes' ) echo ' limit-width'; ?> menu-<?php echo esc_attr($filter_style); ?> text-<?php echo esc_attr($filtering_position); ?>">
                        <ul class="menu-smart<?php if ( $filtering_uppercase === 'yes' ) echo ' text-uppercase'; ?>">
                            ...
                            foreach ( $categories as $key => $cat ): ?>
                                <li class="filter-cat-<?php echo esc_attr($key); ?>"><span><a href="#"
                                                                                              data-filter="grid-cat-<?php echo esc_attr($key); ?>"
                                                                                              class="<?php if ( isset($_GET['ucat']) && $_GET['ucat'] == $key ) echo 'active'; ?>"><?php echo esc_attr(key($cat)) ?></a></span>
                                </li>
                            <?php endforeach; ?>
                        </ul>
                    </div>
    ...
    <div class="<?php echo esc_attr(trim(implode(' ', $parent_container_classes))); ?>">
        <?php if ($type == 'justified') { ?>
        <div class="<?php echo esc_attr(trim(implode(' ', $fixer_classes))); ?>"><?php } ?>
            <?php
            $div_data_attributes = array_map(function ($v, $k) {
                return $k . '="' . $v . '"';
            }, $div_data, array_keys($div_data));
            ?>
            <div<?php if ( $type === 'carousel' ) echo ' id="' . esc_attr($el_id) . '"'; ?>
                    class="<?php echo esc_attr(trim(implode(' ', $container_classes))); ?>" <?php echo implode(' ', $div_data_attributes); ?>>
                <?php
                /**
                 * init loop
                 */
