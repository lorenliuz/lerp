...
$css_class = apply_filters( VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, 'lerp-share', $this->settings['base'], $atts );
...
$output .= '<div class="lerp-wrapper '.esc_attr(trim($css_class)).'" '.implode(' ', $div_data_attributes).'>';
