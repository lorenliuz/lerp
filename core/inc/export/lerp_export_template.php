 ...
 */
function lerp_export_wp($args = array())
{
    global $wpdb, $post;
    ...
    >
        ...
        <channel>
            ...
            <?php foreach ( $cats as $c ) : ?>
                <wp:category>
                    <wp:term_id><?php echo wp_kses_post($c->term_id); ?></wp:term_id>
                    <wp:category_nicename><?php echo esc_html($c->slug); ?></wp:category_nicename>
                    <wp:category_parent><?php if ( $c->parent ) echo esc_html($cats[$c->parent]->slug); ?></wp:category_parent><?php wxr_cat_name($c); ?><?php wxr_category_description($c); ?>
                </wp:category>
            <?php endforeach; ?>
            <?php foreach ( $tags as $t ) : ?>
                <wp:tag>
                    <wp:term_id><?php echo esc_html($t->term_id); ?></wp:term_id>
                    <wp:tag_slug><?php echo esc_html($t->slug); ?></wp:tag_slug><?php wxr_tag_name($t); ?><?php wxr_tag_description($t); ?>
                </wp:tag>
            <?php endforeach; ?>
            <?php foreach ( $terms as $t ) : ?>
                <wp:term>
                    ...
                    <wp:term_parent><?php if ( $t->parent ) echo esc_html($terms[$t->parent]->slug); ?></wp:term_parent><?php wxr_term_name($t); ?><?php wxr_term_description($t); ?>
                </wp:term>
            <?php endforeach; ?>
                        ...
                        <item>
                            ...
                            if ( $post->post_type == 'attachment' ) :
                                if ( strpos($post->post_mime_type, 'image/') !== false && $post->post_mime_type !== 'image/url' && $post->post_mime_type !== 'image/url' && strpos($post_guid, 'undsgn.com') !== false ) {
                                    ...
                                    $media_url = 'http://static.undsgn.com/lerp/placeholder/' . $media_name;
                                    $post_guid = 'http://static.undsgn.com/lerp/placeholder/' . $media_name;
