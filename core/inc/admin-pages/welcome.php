...
if ( !empty($_SESSION['ignore_walkthrough']) ) {
    ...
    <div class="update-nag">
        ...
        <form method="POST">
            <input type="submit" class="button button-primary" value="<?php esc_html_e('Run Installer', 'lerp'); ?>"
                   name="install_lerp">
        </form>
    </div>
    <?php exit;
        ...
        <div class="lerp-admin-panel__content lerp-admin-panel__content--two-cols">
            ...
            <div class="lerp-admin-panel__left">
                ...
                <div class="lerp-info-box">
                    ...
                    <form method="POST" id="lerp_api_credentials_form"
                          class="lerp-registration-form lerp-registration-form--<?php echo $license_ok ? 'license-ok' : ''; ?> <?php echo $envato_toolkit_active ? 'lerp-registration-form--toolkit-active' : 'toolkit-not-active'; ?> lerp-registration-form--<?php echo $license_already_in_use ? 'already-in-use' : ''; ?>">
                        ...
                        <div class="format-setting-wrap">
                            ...
                            <div class="format-setting has-desc">
                                ...
                                <div class="format-setting-inner">
                                    <input type="text" name="envato_username" id="envato_username"
                                           class="widefat option-tree-ui-input"
                                           value="<?php echo (!$is_deregistering_license && isset($toolkitData['user_name']) && $toolkitData['user_name']) ? $toolkitData['user_name'] : ''; ?>" <?php echo $license_ok && !$license_already_in_use ? 'disabled' : ''; ?>>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="format-setting-wrap">
                            ...
                            <div class="format-setting has-desc">
                                ...
                                <div class="format-setting-inner">
                                    <input type="text" name="envato_api_key" id="envato_api_key"
                                           class="widefat option-tree-ui-input"
                                           value="<?php echo (!$is_deregistering_license && isset($toolkitData['api_key']) && $toolkitData['api_key']) ? $toolkitData['api_key'] : ''; ?>" <?php echo $license_ok && !$license_already_in_use ? 'disabled' : ''; ?>>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="format-setting-wrap">
                            ...
                            <div class="format-setting has-desc">
                                ...
                                <div class="format-setting-inner">
                                    <input type="text" name="envato_purchase_code" id="envato_purchase_code"
                                           class="widefat option-tree-ui-input"
                                           value="<?php echo (!$is_deregistering_license && isset($toolkitData['purchase_code']) && $toolkitData['purchase_code']) ? $toolkitData['purchase_code'] : ''; ?>" <?php echo $license_ok && !$license_already_in_use ? 'disabled' : ''; ?>>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <p style="display: none;"
                               class="lerp-admin-panel__description lerp-admin-registration-info lerp-admin-registration-info--license-invalid lerp-ui-notice lerp-ui-notice--error"
                               id="license_error"><?php esc_html_e('You have entered invalid credentials, or your Envato account does not include Lerp among your purchased items.', 'lerp'); ?></p>
                            <p style="display: none;"
                               class="lerp-admin-panel__description lerp-admin-registration-info lerp-admin-registration-info--license-invalid lerp-ui-notice lerp-ui-notice--error"
                               id="license_empty"><?php esc_html_e('Please fill out all required fields.', 'lerp'); ?></p>
                            ...
                            <?php if ( $license_already_in_use ) : ?>
                                <p class="lerp-admin-panel__description lerp-admin-registration-info lerp-admin-registration-info--license-invalid lerp-ui-notice lerp-ui-notice--error">
                                    <?php printf(wp_kses(__('This product is in use on another domain: <span>%s</a>', 'lerp'), array('span' => array())), $connected_domain); ?>
                                    <br>
                                    <?php printf(esc_html__('Are you using this theme on a new domain? %s.', 'lerp'), '<a tabindex="-1" href="' . esc_url('//themeforest.net/item/lerp-creative-multiuse-wordpress-theme/13373220?utm_source=undsgn_support&ref=undsgn&license=regular&open_purchase_for_item_id=13373220&purchasable=source') . '" target="_blank">' . esc_html__('Purchase a new license', 'lerp') . '</a>'); ?>
                                </p>
                            ...
                            <?php if ( $register_button_text ) : ?>
                                <button class="button button-primary"
                                        type="submit"<?php if ( !$envato_toolkit_active ) echo ' disabled'; ?>
                                        id="envato_update_info"
                                        name="envato_update_info"<?php echo !$envato_toolkit_active ? ' disabled' : ''; ?>>
                                    <span><span class="lerp-ot-spinner"></span><?php echo esc_attr($register_button_text); ?></span>
                                </button>
                            <?php endif ?>
                        </div>
                    ...
                    <?php if ( $toolkitData && !$is_deregistering_license && !$license_already_in_use ) : ?>
                        <form id="change_license_form" method="POST">
                            <button type="submit" class="button button-primary"
                                    name="change_license"><?php echo esc_html__('Deregister your product', 'lerp'); ?></button>
                        </form>
                    <?php endif; ?>
                </div><!-- .lerp-info-box -->
                    ...
                    <tr>
                        ...
                        <td class="get-max-input-vars">
                            ...
                            <?php else : ?>
                                ...
                                <mark class="error no_data"
                                      style="display: none;"><?php esc_html_e('No available data', 'lerp'); ?></mark>
                                <a href="#" id="max_vars_checker"><i class="fa fa-refresh"></i></a>
                            <?php endif; ?>
                        </td>
                    </tr>
