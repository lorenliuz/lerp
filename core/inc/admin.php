...
function uncode_admin_menu()
{
    if (current_user_can('edit_theme_options')) {
        ...
        add_submenu_page('uncode-system-status', 'UNCODE', esc_html__('系统状态', 'uncode'), 'administrator', 'uncode-system-status', 'uncode_welcome_page');
    }
}
...
function uncode_init_admin_css()
{
    ...
    wp_enqueue_style('admin-uncode-icons', get_template_directory_uri() . '/lib/assets/css/uncode-icons.css', false, $resources_version);
        ...
        <div class="format-setting-inner">
            <div class="option-tree-ui-upload-parent">
                ...
                <a href="javascript:void(0);" class="ot_upload_media option-tree-ui-button button button-primary light"
                   title="Add Media"><span class="icon fa fa-plus2"></span><?php esc_html_e('Add media', 'uncode'); ?>
                </a>
            </div>
        </div>
        <p class="description"
           style="padding-top: 22px;"><?php esc_html_e('Select a media assigned to the category.', 'uncode'); ?></p>
    </div>
    <div class="form-field">
        ...
        <p class="description"
           style="padding-top: 22px;"><?php esc_html_e('Select a color assigned to the category.', 'uncode'); ?></p>
    </div>
...
function uncode_taxonomy_edit_meta_field($term)
{
    ...
    <tr class="form-field">
        <th scope="row" valign="top"><label
                    for="term_meta[term_media]"><?php esc_html_e('Featured media', 'uncode'); ?></label></th>
        <td>
            <div class="format-setting-inner">
                <div class="option-tree-ui-upload-parent">
                    ...
                    <a href="javascript:void(0);"
                       class="ot_upload_media option-tree-ui-button button button-primary light" title="Add Media"><span
                                class="icon fa fa-plus2"></span><?php esc_html_e('Add media', 'uncode'); ?></a>
                </div>
            </div>
            <?php
    ...
    <tr class="form-field">
        <th scope="row" valign="top"><label for="term_meta[term_color]"><?php esc_html_e('Color', 'uncode'); ?></label>
        </th>
        <td>
            <select name="term_meta[term_color]" id="term_meta[term_color]" class="term_color">
                <?php
...
function uncode_display_metabox()
{
    ...
    <input type="hidden" name="uncode_medias_noncedata" id="uncode_medias_noncedata"
           value="<?php echo wp_create_nonce('uncode_medias_noncedata'); ?>"/>

    <div class="edit_form_line">
        <input type="hidden" class="wpb_vc_param_value uncode_gallery_attached_images_ids medias media_element"
        ...
        <a class="add_media_widget vc_btn vc_btn-sm vc_btn-primary add_media_widget--with-galleries" href="#"
           use-single="false" title="Add media"><?php esc_html_e('Select medias', 'uncode'); ?></a>
        <a href="#"
           class="vc_btn vc_btn-sm vc_btn-grey btn-remove-all"<?php if ($ids === '') echo ' style="display:none;"'; ?>><?php esc_html_e('Remove All', 'uncode'); ?></a>
    ...
    <div class="edit_form_line">
        <p>
            ...
            <label class="screen-reader-text"
                   for="media_display"><?php esc_html_e('Post media display', 'uncode') ?></label>
        </p>
        <p>
        ...
        function uncode_js_composer_nag()
        {
            ...
            <div class="notice error is-dismissible">
                ...
                <p><a class="button button-primary button-hero deactivate-jscomposer" href="#"
                      aria-label="Deactivate WPBakery Visual Composer"><?php esc_attr_e('Deactivate WPBakery Visual Composer', 'uncode'); ?></a>
                </p>
...
function uncode_support_admin_bar_menu($wp_admin_bar)
{
    ...
    $wp_admin_bar->add_node(array(
        'id' => 'uncode-help',
        'title' => esc_html__('Lerp 帮助中心', 'uncode'),
        ...
        <table class="form-table">
            <tr id="user-featured-image" class="user-featured-image-wrap">
                ...
                <td>
                    <div class="format-setting-inner">
                        <div class="option-tree-ui-upload-parent">
                            <input type="text" name="user_uncode_meta[term_media]" id="term_media"
                                   value="<?php echo esc_attr(isset($user_uncode_meta['term_media']) ? $user_uncode_meta['term_media'] : ''); ?>"
                                   class="widefat option-tree-ui-upload-input " readonly="">
                            <a href="javascript:void(0);"
