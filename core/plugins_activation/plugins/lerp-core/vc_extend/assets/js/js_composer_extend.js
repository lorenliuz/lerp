jQuery(document).ready(function($) {
	window.LerpSectionView = window.VcSectionView.extend({
		...
		ready: function(e) {
			window.LerpRowView.__super__.ready.call(this, e);
			if (this.$content.closest('.wpb_lerp_slider').length) {
	...
	window.LerpRowView = window.VcRowView.extend({
		buildDesignHelpers: function() {
			var color = this.model.getParam('back_color'),
				image = this.model.getParam('back_image'),
				$column_edit = this.$el.find('> .vc_controls .column_edit'),
	...
	window.LerpColumnView = window.VcColumnView.extend({
		buildDesignHelpers: function() {
			var color = this.model.getParam('back_color'),
				image = this.model.getParam('back_image'),
	...
	window.LerpTextView = vc.shortcode_view.extend({
		changedContent: function(model) {
			...
			window.LerpTextView.__super__.changedContent.call(this, model);
		}
	});
	window.LerpAccordionView = window.VcAccordionView.extend({
		render: function() {
			window.LerpAccordionView.__super__.render.call(this);
	...
	window.LerpBlockView = vc.shortcode_view.extend({
		changeShortcodeParams: function ( model ) {
			window.LerpBlockView.__super__.changeShortcodeParams.call( this, model );
	...
	window.LerpPanelsView = vc.shortcode_view.extend({
        adding_new_tab: !1,
        events: {
