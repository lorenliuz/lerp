...
class LerpFont
{
                                ...
                                <div id="post-body-content">
                                    <div id="section_font_stack">
                                        ...
                                        <form method="post" action="options.php">
                                            <input type="submit" name="Submit"
                                                   class="button button-primary lerp-ui-button"
                                                   value="<?php esc_html_e('导入并保存字体', 'lerp'); ?>"/>
                                            <?php $this->show_stack(); ?>
                                            ...
                                            <input type='hidden' id="uf-preview-link"
                                                   value="<?php echo get_template_directory_uri() . '/core/font-system/preview.php'; ?>"/>
                                        </form>
                                    ...
                                    <div id="section_font_source_settings" class='font-source-settings'>
                                        ...
                                        <form method="post" action="options.php">
                                            ...
                                            <input type="submit" name="Submit"
                                                   class="button button-primary lerp-ui-button"
                                                   value="<?php esc_html_e('Save Font Libraries', 'lerp'); ?>"/>
                                            ...
                                            <div class="font-sources__list">
                                                    ...
                                                    <div class="lerp-info-box">
                                                        ...
                                                        <div class="font-source__field">
                                                            <label class="font-source__label">
                                                                <strong><?php esc_html_e('Enter your API Key', 'lerp'); ?>
                                                                    :</strong>
                                                                <input class="font-source__input widefat" type="text"
                                                                       id="typekit_api_key"
                                                                       name="lerp_font_options[typekit_api_key]"
                                                        ...
                                                        <div class="font-source__field">
                                                            <label class="font-source__label">
                                                                <strong><?php esc_html_e('Enter your Kit ID', 'lerp'); ?>
                                                                    :</strong>
                                                                <input class="font-source__input widefat" type="text"
                                                                       id="typekit_kit_ID"
                                                                       name="lerp_font_options[typekit_kit_ID]"
                                                    ...
                                                    <div class="lerp-info-box">
                                                        ...
                                                        <div class="font-source__field">
                                                            <label class="font-source__label">
                                                                ...
                                                                <input class="font-source__input widefat" type="text"
                                                                       id="fondeck_project"
                                                                       name="lerp_font_options[fontdeck_project]"
                                                ...
                                                <div id="font-source-squirrel" class="font-source">
                                                    <div class="lerp-info-box">
                                                        ...
                                                        <div class="font-source__field">
                                                            <p>
                                                                <strong><?php esc_html_e('Pull fonts from Font Squirrel?', 'lerp'); ?></strong>
                                                            </p>
                                                            <label class="font-source__label">
                                                                <input class="font-source__input" type="radio"
                                                                       name="lerp_font_options[fontsquirrel_pull]" <?php if ( isset($this->options['fontsquirrel_pull']) ) {
                                                                    checked($this->options['fontsquirrel_pull'], 'pull');
                                                                } else {
                                                                    echo 'checked';
                                                                } ?> value='pull'/> <?php esc_html_e('Pull', 'lerp'); ?>
                                                            </label>
                                                            <label class="font-source__label">
                                                                <input class="font-source__input" type="radio"
                                                                       name="lerp_font_options[fontsquirrel_pull]" <?php if ( isset($this->options['fontsquirrel_pull']) ) checked($this->options['fontsquirrel_pull'], 'dont-pull'); ?>
                                                                       value='dont-pull'/> <?php esc_html_e('Don\'t Pull', 'lerp'); ?>
                                                            </label>
                                                        </div>

                                                        <div class="font-source__field">
                                                            <p>
                                                                <strong><?php esc_html_e('Combine Font Squirrel CSS files?', 'lerp'); ?></strong>
                                                            </p>
                                                            <label class="font-source__label">
                                                                <input class="font-source__input" type="radio"
                                                                       name="lerp_font_options[fontsquirrel_combine]" <?php if ( isset($this->options['fontsquirrel_combine']) ) {
                                                                    checked($this->options['fontsquirrel_combine'], 'combine');
                                                                } else {
                                                                    echo 'checked';
                                                                } ?>
                                                                       value='combine'/> <?php esc_html_e('Combine', 'lerp'); ?>
                                                            </label>
                                                            <label class="font-source__label">
                                                                <input class="font-source__input" type="radio"
                                                                       name="lerp_font_options[fontsquirrel_combine]" <?php if ( isset($this->options['fontsquirrel_combine']) ) checked($this->options['fontsquirrel_combine'], 'dont-combine'); ?>
                                                                       value='dont-combine'/> <?php esc_html_e('Don\'t Combine', 'lerp'); ?>
                                                            </label>
                                                        </div>
                                                    </div><!-- .font-source -->
    ...
    { ?>
        <div class="uf-font-container">
            ...
            <input type='hidden' id="font_stack" name="lerp_font_options[font_stack]"
