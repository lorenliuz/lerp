...
function vc_page_welcome_add_sub_page() {
	// Add submenu page
	$page = add_submenu_page( VC_PAGE_MAIN_SLUG, __( 'About', 'page_builder' ), __( 'About', 'page_builder' ), 'edit_posts', vc_page_welcome_slug(), 'vc_page_welcome_render' );
...
function vc_get_page_welcome_tabs() {
	...
	$vc_page_welcome_tabs = apply_filters( 'vc_page-welcome-slugs-list', array(
		'vc-welcome' => __( 'What\'s New', 'page_builder' ),
		'vc-faq' => __( 'FAQ', 'page_builder' ),
		'vc-resources' => __( 'Resources', 'page_builder' ),
	) );
