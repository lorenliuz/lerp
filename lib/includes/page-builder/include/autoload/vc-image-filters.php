...
function vc_get_filters() {
	return array(
		'antique' => __( 'Antique', 'page_builder' ),
		'blackwhite' => __( 'Black & White', 'page_builder' ),
		'boost' => __( 'Boost', 'page_builder' ),
		'concentrate' => __( 'Concentrate', 'page_builder' ),
		'country' => __( 'Country', 'page_builder' ),
		'darken' => __( 'Darken', 'page_builder' ),
		'dream' => __( 'Dream', 'page_builder' ),
		'everglow' => __( 'Everglow', 'page_builder' ),
		'forest' => __( 'Forest', 'page_builder' ),
		'freshblue' => __( 'Fresh Blue', 'page_builder' ),
		'frozen' => __( 'Frozen', 'page_builder' ),
		'hermajesty' => __( 'Her Majesty', 'page_builder' ),
		'light' => __( 'Light', 'page_builder' ),
		'orangepeel' => __( 'Orange Peel', 'page_builder' ),
		'rain' => __( 'Rain', 'page_builder' ),
		'retro' => __( 'Retro', 'page_builder' ),
		'sepia' => __( 'Sepia', 'page_builder' ),
		'summer' => __( 'Summer', 'page_builder' ),
		'tender' => __( 'Tender', 'page_builder' ),
		'vintage' => __( 'Vintage', 'page_builder' ),
		'washed' => __( 'Washed', 'page_builder' ),
	);
}
...
function vc_attachment_filter_field( $form_fields, $post ) {
	...
	$html_options = '<option value="">' . __( 'None', 'page_builder' ) . '</option>';
	...
	$form_fields['vc-image-filter'] = array(
		...
		'html' => '
			<div style="display:none">
				<span class="vc-filter-label">' . __( 'Image filter', 'page_builder' ) . '</span>
...
function vc_attachment_filter_media_meta( $media_meta, $post ) {
	...
	$media_meta .= __( 'Filter:', 'page_builder' ) . ' ' . $filters[ $filter_name ];
