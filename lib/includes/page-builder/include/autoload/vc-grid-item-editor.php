		...
		$pointers['vc_grid_item'] = array(
			...
			'messages' => array(
				array(
					...
					'options' => array(
						'content' => sprintf( '<h3> %s </h3> <p> %s </p>', __( 'Start Here!', 'page_builder' ), __( 'Start easy - use predefined template as a starting point and modify it.', 'page_builder' ) ),
						'position' => array(
							'edge' => 'left',
							'align' => 'center',
						),
				...
				array(
					...
					'options' => array(
						'content' => sprintf( '<h3> %s </h3> <p> %s </p>', __( 'Use Animations', 'page_builder' ), __( 'Select animation preset for grid element. "Hover" state will be added next to the "Normal" state tab.', 'page_builder' ) ),
						'position' => array(
							'edge' => 'right',
							'align' => 'center',
						),
				...
				array(
					...
					'options' => array(
						'content' => sprintf( '<h3> %s </h3> <p> %s </p>', __( 'Style Design Options', 'page_builder' ), __( 'Edit "Normal" state to set "Featured image" as a background, control zone sizing proportions and other design options (Height mode: Select "Original" to scale image without cropping).', 'page_builder' ) ),
						'position' => array(
							'edge' => 'bottom',
							'align' => 'center',
						),
				...
				array(
					...
					'options' => array(
						'content' => sprintf( '<h3> %s </h3> <p> %s </p>', __( 'Extend Element', 'page_builder' ), __( 'Additional content zone can be added to grid element edges (Note: This zone can not be animated).', 'page_builder' ) ) . '<p><img src="' . vc_asset_url( 'vc/gb_additional_content.png' ) . '" alt="" /></p>',
						'position' => array(
							'edge' => 'right',
							'align' => 'center',
						),
				...
				array(
					'target' => '#wpadminbar',
					'options' => array(
						'content' => sprintf( '<h3> %s </h3> %s', __( 'Watch Video Tutorial', 'page_builder' ), '<p>' . __( 'Have a look how easy it is to work with grid element builder.', 'page_builder' ) . '</p>' . '<iframe width="500" height="281" src="//www.youtube.com/embed/sBvEiIL6Blo" frameborder="0" allowfullscreen></iframe>' ),
						'position' => array(
							'edge' => 'top',
							'align' => 'center',
						),
