...
class Vc_Backend_Editor implements Vc_Editor_Interface {
	...
	public function render( $post_type ) {
		if ( $this->isValidPostType( $post_type ) ) {
			...
			// meta box to render
			add_meta_box( 'wpb_visual_composer', __( 'WPBakery Page Builder', 'page_builder' ), array(
				$this,
				'renderEditor',
	...
	public function registerBackendCss() {
		wp_register_style( 'page_builder', vc_asset_url( 'css/page_builder_backend_editor.min.css' ), array(), WPB_VC_VERSION, false );
