...
class Vc_Navbar implements Vc_Render {
	...
	public function getLogo() {
		$output = '<a id="vc_logo" class="vc_navbar-brand" title="' . __( 'WPBakery Page Builder', 'page_builder' )
		          . '" href="' . esc_attr( $this->brand_url ) . '" target="_blank">'
		          . __( 'WPBakery Page Builder', 'page_builder' ) . '</a>';
	...
	public function getControlCustomCss() {
		...
		return '<li class="vc_pull-right"><a id="vc_post-settings-button" href="javascript:;" class="vc_icon-btn vc_post-settings" title="'
		       . __( 'Page settings', 'page_builder' ) . '">'
		       . '<span id="vc_post-css-badge" class="vc_badge vc_badge-custom-css" style="display: none;">' . __( 'CSS', 'page_builder' )
	...
	public function getControlFullscreen() {
		return '<li class="vc_show-mobile vc_pull-right">'
		       . '<a id="vc_fullscreen-button" class="vc_icon-btn vc_fullscreen-button" title="'. __( 'Full screen', 'page_builder' ) . '"><i class="vc-composer-icon vc-c-icon-fullscreen"></i></a>'
		       . '</li>';
	}
	...
	public function getControlWindowed() {
		return '<li class="vc_show-mobile vc_pull-right">'
		       . '<a id="vc_windowed-button" class="vc_icon-btn vc_windowed-button" title="'. __( 'Exit full screen', 'page_builder' ) . '"><i class="vc-composer-icon vc-c-icon-fullscreen_exit"></i></a>'
		       . '</li>';
	}
	...
	public function getControlAddElement() {
		if ( vc_user_access()
			...
			return '<li class="vc_show-mobile">'
			       ...
			       . '' . __( 'Add new element', 'page_builder' ) . '">'
	...
	public function getControlTemplates() {
		...
		return '<li><a href="javascript:;" class="vc_icon-btn vc_templates-button"  id="vc_templates-editor-button" title="'
		       . __( 'Templates', 'page_builder' ) . '"><i class="vc-composer-icon vc-c-icon-add_template"></i></a></li>';
	}
	...
	public function getControlFrontend() {
		...
		return '<li class="vc_pull-right" style="display: none;">'
		       . '<a href="' . vc_frontend_editor()->getInlineUrl() . '" class="vc_btn vc_btn-primary vc_btn-sm vc_navbar-btn" id="wpb-edit-inline">' . __( 'Frontend', 'page_builder' ) . '</a>'
		       . '</li>';
	}
	...
	public function getControlSaveBackend() {
		return '<li class="vc_pull-right vc_save-backend">'
		       . '<a href="javascript:;" class="vc_btn vc_btn-grey vc_btn-sm vc_navbar-btn vc_control-preview">' . __( 'Preview', 'page_builder' ) . '</a>'
		       . '<a class="vc_btn vc_btn-sm vc_navbar-btn vc_btn-primary vc_control-save" id="wpb-save-post">' . __( 'Update', 'page_builder' ) . '</a>'
		       . '</li>';
	}
}
