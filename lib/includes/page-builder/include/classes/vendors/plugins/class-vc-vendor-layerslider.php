...
class Vc_Vendor_Layerslider implements Vc_Vendor_Interface {
  ...
  " );
			...
			if ( ! empty( $ls ) ) {
				...
				$layer_sliders[ __( 'No sliders found', 'page_builder' ) ] = 0;
			}
		} else {
		...
		return array(
			'base' => $tag,
			'name' => __( 'Layer Slider', 'page_builder' ),
			'icon' => 'icon-wpb-layerslider',
			'category' => __( 'Content', 'page_builder' ),
			'description' => __( 'Place LayerSlider', 'page_builder' ),
			'params' => array(
				array(
					'type' => 'textfield',
				...
				array(
					'type' => 'dropdown',
					'heading' => __( 'LayerSlider ID', 'page_builder' ),
					'param_name' => 'id',
					'admin_label' => true,
					'value' => $layer_sliders,
					'save_always' => true,
					'description' => __( 'Select your LayerSlider.', 'page_builder' ),
				),
				array(
					'type' => 'textfield',
