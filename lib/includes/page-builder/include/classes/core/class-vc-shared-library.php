...
class VcSharedLibrary {
	...
	public static function getColorsDashed() {
		$colors = array(
			__( 'Blue', 'page_builder' ) => 'blue',
			__( 'Turquoise', 'page_builder' ) => 'turquoise',
			__( 'Pink', 'page_builder' ) => 'pink',
			__( 'Violet', 'page_builder' ) => 'violet',
			__( 'Peacoc', 'page_builder' ) => 'peacoc',
			__( 'Chino', 'page_builder' ) => 'chino',
			__( 'Mulled Wine', 'page_builder' ) => 'mulled-wine',
			__( 'Vista Blue', 'page_builder' ) => 'vista-blue',
			__( 'Black', 'page_builder' ) => 'black',
			__( 'Grey', 'page_builder' ) => 'grey',
			__( 'Orange', 'page_builder' ) => 'orange',
			__( 'Sky', 'page_builder' ) => 'sky',
			__( 'Green', 'page_builder' ) => 'green',
			__( 'Juicy pink', 'page_builder' ) => 'juicy-pink',
			__( 'Sandy brown', 'page_builder' ) => 'sandy-brown',
			__( 'Purple', 'page_builder' ) => 'purple',
			__( 'White', 'page_builder' ) => 'white',
		);
