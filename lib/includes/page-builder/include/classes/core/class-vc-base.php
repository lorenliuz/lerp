...
class Vc_Base {
	...
	public function getEditorsLocale() {
		return array(
			...
			'main_button_title' => __( 'Lerp Page Builder', 'page_builder' ),
			'main_button_title_backend_editor' => __( '后端编辑器', 'page_builder' ),
			'main_button_title_frontend_editor' => __( '前端编辑器', 'page_builder' ),
			'main_button_title_revert' => __( '经典模式', 'page_builder' ),
