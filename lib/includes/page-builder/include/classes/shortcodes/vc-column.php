...
class WPBakeryShortCode_VC_Column extends WPBakeryShortCode {
	...
	public function getColumnControls( $controls, $extended_css = '' ) {
		...
		if ( ' bottom-controls' === $extended_css ) {
			$control_title = __( 'Append to this column', 'page_builder' );
		} else {
			$control_title = __( 'Prepend to this column', 'page_builder' );
		}
		...
		$controls_edit = '<a class="vc_control column_edit vc_column-edit"  data-vc-control="edit" href="#" title="' . __( 'Edit this column', 'page_builder' ) . '"><i class="vc-composer-icon vc-c-icon-mode_edit"></i></a>';
		$controls_delete = '<a class="vc_control column_delete vc_column-delete" data-vc-control="delete"  href="#" title="' . __( 'Delete this column', 'page_builder' ) . '"><i class="vc-composer-icon vc-c-icon-delete_empty"></i></a>';
