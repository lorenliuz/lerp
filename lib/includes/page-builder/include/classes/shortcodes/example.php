...
vc_map( array(
	'base' => 'my_hello_world',
	'name' => __( 'Hello World', 'page_builder' ),
	'class' => '',
	'icon' => 'icon-heart',
	'params' => array(
		array(
			...
			'holder' => 'h3',
			'class' => '',
			'heading' => __( 'Foo attribute', 'page_builder' ),
			'param_name' => 'foo',
			'value' => __( "I'm foo attribute", 'page_builder' ),
			'description' => __( 'Enter foo value.', 'page_builder' ),
		),
		array(
			'type' => 'textarea_html',
			'holder' => 'div',
			...
			'param_name' => 'content',
			'value' => __( "I'm hello world", 'page_builder' ),
			'description' => __( 'Enter your content.', 'page_builder' ),
		),
		array(
			'type' => 'dropdown',
			'heading' => __( 'Drop down example', 'page_builder' ),
			'param_name' => 'my_dropdown',
			'value' => array( 1, 2, 'three' ),
			'description' => __( 'One, two or three?', 'page_builder' ),
		),
	),
) );
