		...
		$output = '
			<div class="' . $css_class . '">
				...
				'extraclass' => 'wpb_flickr_heading',
					...
					<p class="flickr_stream_wrap"><a class="wpb_follow_btn wpb_flickr_stream" href="http://www.flickr.com/photos/' . $flickr_id . '">' . __( 'View stream on flickr', 'page_builder' ) . '</a></p>
				</div>
			</div>
		';
