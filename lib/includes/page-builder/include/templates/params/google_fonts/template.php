...
<div class="vc_row-fluid vc_column">
	<div class="wpb_element_label"><?php _e( 'Font Family', 'page_builder' ); ?></div>
...
<?php if ( isset( $fields['no_font_style'] ) && false === $fields['no_font_style'] || ! isset( $fields['no_font_style'] ) ) : ?>
	<div class="vc_row-fluid vc_column">
		<div class="wpb_element_label"><?php _e( 'Font style', 'page_builder' ); ?></div>
...
<div class="vc_row-fluid vc_column vc_google_fonts_form_field-preview-wrapper">
	<div class="wpb_element_label"><?php _e( 'Google Fonts preview', 'page_builder' ); ?>:</div>
	<div class="vc_google_fonts_form_field-preview-container">
		<span><?php _e( 'Grumpy wizards make toxic brew for the evil Queen and Jack.', 'page_builder' ); ?></span>
	</div>
