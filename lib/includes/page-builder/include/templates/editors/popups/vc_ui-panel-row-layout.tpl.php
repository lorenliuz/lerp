...
<div class="vc_ui-font-open-sans vc_ui-panel-window vc_media-xs vc_ui-panel" data-vc-panel=".vc_ui-panel-header-header" data-vc-ui-element="panel-row-layout" id="vc_ui-panel-row-layout">
	<div class="vc_ui-panel-window-inner">
		<?php vc_include_template('editors/popups/vc_ui-header.tpl.php', array(
			'title' => __( 'Row Layout', 'page_builder' ),
			...
			<div class="vc_ui-panel-content vc_properties-list vc_edit_form_elements" data-vc-ui-element="panel-content">
				<div class="vc_row vc_ui-flex-row">
					<div class="vc_col-sm-12 vc_column vc_layout-panel-switcher">
						<div class="wpb_element_label"><?php _e( 'Row layout', 'page_builder' ) ?></div>
						...
						<?php endforeach ?>
						<span
							class="vc_description vc_clearfix"><?php _e( 'Select row layout from predefined options.', 'page_builder' ); ?></span>
					</div>
					<div class="vc_col-sm-12 vc_column">
						<div class="wpb_element_label"><?php _e( 'Enter custom layout for your row', 'page_builder' ) ?></div>
						<div class="edit_form_line">
							<input name="padding" class="wpb-textinput vc_row_layout" type="text" value="" id="vc_row-layout">
							<span class="vc_general vc_ui-button vc_ui-button-size-sm vc_ui-button-action vc_ui-button-shape-rounded vc_ui-button-update-layout" data-vc-ui-element="button-update-layout"><?php _e( 'Update', 'page_builder' ) ?></span>
					<span
						class="vc_description vc_clearfix"><?php _e( 'Change particular row layout manually by specifying number of columns and their size value.', 'page_builder' ); ?></span>
						</div>
					</div>
				</div>
			</div>
