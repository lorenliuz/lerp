...
<div class="vc_ui-font-open-sans vc_ui-panel-window vc_preset-panel vc_media-xs vc_ui-panel"
	...
	<div class="vc_ui-panel-window-inner">
		<?php vc_include_template( 'editors/popups/vc_ui-header.tpl.php', array(
			'title' => __( 'My Elements', 'page_builder' ),
			'controls' => array(
				'minimize',
				'close',
			),
		...
		<div class="vc_ui-panel-content-container">
			<div class="vc_ui-panel-content vc_properties-list vc_row"
				...
				<div class="vc_column vc_col-sm-12">
					<h3><?php _e( 'Manage My Elements', 'page_builder' );?></h3>
					<p class="vc_description"><?php _e( 'Remove existing elements', 'page_builder' );?></p>
				</div>
				<div class="vc_column vc_col-sm-12">
						...
						<div class="vc_ui-template" style="display:none;">
							<div class="vc_ui-list-bar-item">
								...
								<div class="vc_ui-list-bar-item-actions">
									<button type="button" class="vc_general vc_ui-control-button" title="<?php _e( 'Add element', 'page_builder' ); ?>" data-template-handler data-vc-ui-add-preset><i class="vc-composer-icon vc-c-icon-add"></i></button>
									<button type="button" class="vc_general vc_ui-control-button" data-vc-ui-delete="preset-title" data-preset="" data-preset-parent="" title="<?php _e( 'Delete element', 'page_builder' ); ?>">
