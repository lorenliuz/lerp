...
<div class="vc_ui-template-preview">
	...
	<div id="wpb_visual_composer" class="postbox " style="display: block;">
		<div class="inside">
			...
			<input type="hidden" name="vc_page_builder_group_access_show_rule"
			       class="vc_page_builder_group_access_show_rule" value="all">
	...
	<input type="hidden" id="wpb_vc_loading" name="wpb_vc_loading"
	       value="<?php esc_attr_e( 'Loading, please wait...', 'page_builder' ) ?>"/>
	<input type="hidden" id="wpb_vc_loading_row" name="wpb_vc_loading_row"
	       value="<?php esc_attr_e( 'Crunching...', 'page_builder' ) ?>"/>
</div>
<?php
