...
<form class="vc_ui-prompt vc_ui-prompt-presets">
	...
	<div class="vc_ui-prompt-title">
		<label for="prompt_title" class="wpb_element_label"><?php _e( 'Element Title', 'page_builder' ) ?></label>
	</div>
		...
		<div class="vc_ui-prompt-column">
			<div class="wpb_el_type_textfield vc_wrapper-param-type-textfield vc_properties-list">
				<div class="edit_form_line">
					...
					<span
						class="vc_description vc_clearfix"><?php _e( 'Enter element title.', 'page_builder' ) ?></span>
				</div>
			</div>
		</div>
		<div class="vc_ui-prompt-column">
			<button type="buttom"
				class="vc_general vc_ui-button vc_ui-button-size-sm vc_ui-button-action vc_ui-button-shape-rounded" id="vc_ui-save-preset-btn" disabled><?php _e( 'Save changes', 'page_builder' ) ?></button>
		</div>
	</div>
</form>
