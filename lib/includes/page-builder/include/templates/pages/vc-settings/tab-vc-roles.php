...
<form action="<?php echo admin_url( 'admin-ajax.php' ); ?>" method="post"
	...
	data-vc-roles="form">
	<div class="tab_intro">
		<p><?php _e( 'Control user group role access to the features and options of WPBakery Page Builder - manage WordPress default and custom roles.', 'page_builder' ) ?></p>
	</div>
	...
	submit_button( __( 'Save Changes', 'page_builder' ), 'primary', 'submit_btn', true, $submit_button_attributes );
	?>
