...
<div class="vc_faq-tab changelog">
	<h3><?php _e( 'New to WPBakery Page Builder or Looking for More Information?', 'page_builder' ); ?></h3>

	<p><?php printf( __( 'WPBakery has complete documentation available at our knowledge base: <a target="_blank" href="%s">kb.wpbakery.com</a> which covers everything related to WPBakery Page Builder starting from Installation and up to more advanced features based on our Inner API.', 'page_builder' ), 'http://kb.wpbakery.com' ); ?></p>
...
<div class="return-to-dashboard">
	<a target="_blank" href="http://kb.wpbakery.com"><?php _e( 'Visit Knowledge Base for more information', 'page_builder' ); ?></a>
</div>
