...
<div class="wrap vc-page-welcome about-wrap">
	<h1><?php echo sprintf( __( 'Welcome to WPBakery Page Builder %s', 'page_builder' ), isset( $matches[0] ) ? $matches[0] : WPB_VC_VERSION ) ?></h1>

	<div class="about-text">
		<?php _e( 'Congratulations! You are about to use most powerful time saver for WordPress ever - page builder plugin with Frontend and Backend editors by WPBakery.', 'page_builder' ) ?>
	</div>
	<div class="wp-badge vc-page-logo">
		<?php echo sprintf( __( 'Version %s', 'page_builder' ), WPB_VC_VERSION ) ?>
	</div>
	<p class="vc-page-actions">
		<?php if ( vc_user_access()
			...
			class="button button-primary"><?php _e( 'Settings', 'page_builder' ) ?></a><?php endif; ?>
