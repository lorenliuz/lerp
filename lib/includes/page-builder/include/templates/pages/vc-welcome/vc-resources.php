...
<div class="vc_resources-tab changelog">
	<div class="feature-section vc_row">
		<div class="vc_col-xs-6">
			<h3><?php _e( 'Resources', 'page_builder' ); ?></h3>

			<p><?php _e( 'There are several resources available to WPBakery Page Builder users to help you to get around plugin:', 'page_builder' ); ?></p>
			<ul>
				<li>
		...
		<div class="vc_col-xs-6">
			<h3><?php _e( 'Official Support', 'page_builder' ); ?></h3>

			<p><?php printf( __( 'To get your support related question answered in the fastest timing, please head over to our <a href="%s" target="_blank">support page</a> and open Support ticket. To open a support ticket you should have a valid support subscription in case if your support has expired you can <a href="%s" target="_blank">purchase support extension</a> on CodeCanyon.', 'page_builder' ), 'http://support.wpbakery.com', 'http://bit.ly/vcomposer' ); ?></p>

			<p><?php printf( __( 'Before applying for support please make sure you understand the rules of support and go through all steps described and listed in <a href="%s" target="_blank">Support Policy</a> in order to get your issues solved as soon as possible.', 'page_builder' ), 'http://go.wpbakery.com/support-policy' ); ?></p>
		</div>
	</div>
</div>
