...
class Vc_IconPicker {
	 ...
	 * wp-content/plugins/page_builder/assets/js/params/composer-atts.js init
	 * method
	...
	protected function setDefaults() {
		...
		if ( ! isset( $this->settings['settings'], $this->settings['settings']['allCategoryText'] ) ) {
			...
			$this->settings['settings']['allCategoryText'] = __( 'From all categories', 'page_builder' );
		}
		if ( ! isset( $this->settings['settings'], $this->settings['settings']['unCategorizedText'] ) ) {
			// If categorized then use this option
			$this->settings['settings']['unCategorizedText'] = __( 'Uncategorized', 'page_builder' );
		}
	 ...
	 * wp-content/plugins/page_builder/include/autoload/hook-vc-iconpicker-param.php
	 * folder
	 * @since 4.4
