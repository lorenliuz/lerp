...
function vc_loop_form_field( $settings, $value ) {
	...
	return '<div class="vc_loop">'
	       ...
	       . '<a href="#" class="button vc_loop-build ' . $settings['param_name'] . '_button" data-settings="' . rawurlencode( json_encode( $settings['settings'] ) ) . '">' . __( 'Build query', 'page_builder' ) . '</a>'
...
class VcLoopSettings {
	...
	function __construct( $value, $settings = array() ) {
		$this->parts = array(
			'size' => __( 'Post count', 'page_builder' ),
			'order_by' => __( 'Order by', 'page_builder' ),
			'order' => __( 'Sort order', 'page_builder' ),
			'post_type' => __( 'Post types', 'page_builder' ),
			'authors' => __( 'Author', 'page_builder' ),
			'categories' => __( 'Categories', 'page_builder' ),
			'tags' => __( 'Tags', 'page_builder' ),
			'tax_query' => __( 'Taxonomies', 'page_builder' ),
			'by_id' => __( 'Individual posts/pages', 'page_builder' ),
		);
	...
	public function parse_order_by( $value ) {
		return $this->parseDropDown( $value, array(
			array( 'date', __( 'Date', 'page_builder' ) ),
			'ID',
			array( 'author', __( 'Author', 'page_builder' ) ),
			array( 'title', __( 'Title', 'page_builder' ) ),
			array( 'modified', __( 'Modified', 'page_builder' ) ),
			array( 'rand', __( 'Random', 'page_builder' ) ),
			array( 'comment_count', __( 'Comment count', 'page_builder' ) ),
			array( 'menu_order', __( 'Menu order', 'page_builder' ) ),
		) );
	}
	...
	public function parse_order( $value ) {
		return $this->parseDropDown( $value, array(
			array( 'ASC', __( 'Ascending', 'page_builder' ) ),
			array( 'DESC', __( 'Descending', 'page_builder' ) ),
		) );
	}
