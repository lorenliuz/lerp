...
class Vc_Templates_Editor_Grid_Item extends Vc_Templates_Panel_Editor {
	...
	protected function renderTemplateWindowGridTemplate( $templateName, $templateData ) {
		...
		$previewTemplateTitle = esc_attr__( 'Preview template', 'page_builder' );
		$addTemplateTitle = esc_attr__( 'Preview template', 'page_builder' );
	...
	public function getAllTemplates() {
		...
		if ( ! empty( $grid_templates ) ) {
			$arr_category = array(
				...
				'category_name' => __( 'Grid Templates', 'page_builder' ),
				'category_weight' => 10,
			);
		...
		if ( ! empty( $custom_grid_templates ) ) {
			$arr_category = array(
				...
				'category_name' => __( 'Custom Grid Templates', 'page_builder' ),
				'category_weight' => 10,
			);
			$category_templates = array();
