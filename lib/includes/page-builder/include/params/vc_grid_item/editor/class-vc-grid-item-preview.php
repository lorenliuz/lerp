...
class Vc_Grid_Item_Preview {
	...
	public function mockingPost() {
		...
		setup_postdata( $post );
		$post->post_title = __( 'Post title', 'page_builder' );
		$post->post_content = __( 'The WordPress Excerpt is an optional summary or description of a post; in short, a post summary.', 'page_builder' );
		$post->post_excerpt = __( 'The WordPress Excerpt is an optional summary or description of a post; in short, a post summary.', 'page_builder' );
