...
class Vc_Grid_Item_Editor extends Vc_Backend_Editor {
	...
	public static function getPostTypesLabels() {
		return array(
			'add_new_item' => __( 'Add Grid template', 'page_builder' ),
			'name' => __( 'Grid Builder', 'page_builder' ),
			'singular_name' => __( 'Grid template', 'page_builder' ),
			'edit_item' => __( 'Edit Grid template', 'page_builder' ),
			'view_item' => __( 'View Grid template', 'page_builder' ),
			'search_items' => __( 'Search Grid templates', 'page_builder' ),
			'not_found' => __( 'No Grid templates found', 'page_builder' ),
			'not_found_in_trash' => __( 'No Grid templates found in Trash', 'page_builder' ),
		);
	}
	...
	public function addMetaBox() {
		add_meta_box( 'wpb_visual_composer', __( 'Grid Builder', 'page_builder' ), array(
			$this,
			'renderEditor',
	...
	public function registerBackendJavascript() {
		...
		wp_localize_script( 'vc_grid_item_editor', 'i18nLocaleGItem', array(
			'preview' => __( 'Preview', 'page_builder' ),
			'builder' => __( 'Builder', 'page_builder' ),
			'add_template_message' => __( 'If you add this template, all your current changes will be removed. Are you sure you want to add template?', 'page_builder' ),
		) );
	}
