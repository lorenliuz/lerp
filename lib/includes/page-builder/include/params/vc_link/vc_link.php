...
function vc_vc_link_form_field( $settings, $value ) {
	...
	return '<div class="vc_link">'
	       ...
	       . '<a href="#" class="button vc_link-build ' . $settings['param_name'] . '_button">' . __( 'Select URL', 'page_builder' ) . '</a> <span class="vc_link_label_title vc_link_label">' . __( 'Title', 'page_builder' ) . ':</span> <span class="title-label">' . $link['title'] . '</span> <span class="vc_link_label">' . __( 'URL', 'page_builder' ) . ':</span> <span class="url-label">' . $link['url'] . ' ' . $link['target'] . '</span>'
	       . '</div>';
}
