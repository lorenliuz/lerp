...
function vc_attach_images_form_field( $settings, $value, $tag, $single = false ) {
	...
	if ( true === $single ) {
		$output .= '<a class="gallery_widget_add_images" href="#" use-single="true" title="'
		           . __( 'Add image', 'page_builder' ) . '"><i class="vc-composer-icon vc-c-icon-add"></i>' . __( 'Add image', 'page_builder' ) . '</a>'; //class: button
	} else {
		$output .= '<a class="gallery_widget_add_images" href="#" title="'
		           . __( 'Add images', 'page_builder' ) . '"><i class="vc-composer-icon vc-c-icon-add"></i>' . __( 'Add images', 'page_builder' ) . '</a>'; //class: button
	}
