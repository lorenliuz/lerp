...
function vc_options_form_field( $settings, $value ) {
	return '<div class="vc_options">'
	       ...
	       . '<a href="#" class="button vc_options-edit ' . $settings['param_name'] . '_button">' . __( 'Manage options', 'page_builder' ) . '</a>'
	       . '</div><div class="vc_options-fields" data-settings="' . htmlspecialchars( json_encode( $settings['options'] ) ) . '"><a href="#" class="button vc_close-button">' . __( 'Close', 'page_builder' ) . '</a></div>';
}
