...
class Vc_AutoComplete {
	...
	public function render() {
		...
		$output .= '<li class="vc_autocomplete-input"><span role="status" aria-live="polite" class="ui-helper-hidden-accessible"></span><input class="vc_auto_complete_param" type="text" placeholder="' . __( 'Click here and start typing...', 'page_builder' ) . '" value="' . $this->value . '" autocomplete="off"></li>' .
