<?php
/*
Plugin Name: Lerp Page Builder (Visual Composer)
...
class Vc_Manager {
	 ...
	 * @var string
	 */
	private $plugin_name = 'page_builder/page_builder.php';
	...
	private function __construct() {
		...
		$this->setPluginName( $this->path( 'APP_DIR', 'page_builder.php' ) );
	...
	public function pluginsLoaded() {
		...
		load_plugin_textdomain( 'page_builder', false, $this->path( 'APP_DIR', 'locale' ) );
	}
