...
return array(
	...
	'weight' => - 50,
	'description' => __( 'A list or dropdown of categories', 'page_builder' ),
	'params' => array(
		array(
			'type' => 'textfield',
		...
		array(
			...
			'value' => array(
				...
				__( 'Show hierarchy', 'page_builder' ) => 'hierarchical',
			),
			'description' => __( 'Select display options for categories.', 'page_builder' ),
		),
		array(
			'type' => 'el_id',
