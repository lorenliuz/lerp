...
return array(
	...
	'params' => array(
		...
		array(
			...
			'description' => __( 'Select tour display style.', 'page_builder' ),
		),
		array(
			'type' => 'dropdown',
			'param_name' => 'shape',
			...
			'description' => __( 'Select tour shape.', 'page_builder' ),
		),
		array(
			'type' => 'dropdown',
			'param_name' => 'color',
			'heading' => __( 'Color', 'page_builder' ),
			'description' => __( 'Select tour color.', 'page_builder' ),
		...
		array(
			...
			'description' => __( 'Select tour spacing.', 'page_builder' ),
			'std' => '1',
		),
		array(
			'type' => 'dropdown',
			...
			'description' => __( 'Select tour gap.', 'page_builder' ),
		),
		array(
			'type' => 'dropdown',
			...
			'description' => __( 'Select tour navigation position.', 'page_builder' ),
		),
		array(
			'type' => 'dropdown',
			...
			'description' => __( 'Select tour section title alignment.', 'page_builder' ),
		),
		array(
			'type' => 'dropdown',
			'param_name' => 'controls_size',
			'value' => array(
				__( 'Auto', 'page_builder' ) => '',
				__( 'Extra large', 'page_builder' ) => 'xl',
				__( 'Large', 'page_builder' ) => 'lg',
				__( 'Medium', 'page_builder' ) => 'md',
				__( 'Small', 'page_builder' ) => 'sm',
				__( 'Extra small', 'page_builder' ) => 'xs',
			),
			'heading' => __( 'Navigation width', 'page_builder' ),
			'description' => __( 'Select tour navigation width.', 'page_builder' ),
		),
		array(
			'type' => 'dropdown',
			'param_name' => 'autoplay',
			...
			'description' => __( 'Select auto rotate for tour in seconds (Note: disabled by default).', 'page_builder' ),
		),
		array(
			'type' => 'textfield',
