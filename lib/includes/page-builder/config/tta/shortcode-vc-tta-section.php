...
if ( $include_icon_params ) {
	...
	$icon_params = array(
		array(
			...
			'description' => __( 'Add icon next to section title.', 'page_builder' ),
		),
		array(
			'type' => 'dropdown',
			'param_name' => 'i_position',
			'value' => array(
				__( 'Before title', 'page_builder' ) => 'left',
				__( 'After title', 'page_builder' ) => 'right',
			),
			'dependency' => array(
				'element' => 'add_icon',
				'value' => 'true',
			),
			'heading' => __( 'Icon position', 'page_builder' ),
			'description' => __( 'Select icon position.', 'page_builder' ),
		),
	);
...
$params = array_merge( array(
	array(
		...
		'description' => __( 'Enter section title (Note: you can leave it empty).', 'page_builder' ),
	),
	array(
		'type' => 'el_id',
		'param_name' => 'tab_id',
		...
		'description' => __( 'Enter section ID (Note: make sure it is unique and valid according to <a href="%s" target="_blank">w3c specification</a>).', 'page_builder' ),
	),
), $icon_params, array(
		array(
			'type' => 'textfield',
...
return array(
	...
	'description' => __( 'Section for Tabs, Tours, Accordions.', 'page_builder' ),
	'params' => $params,
