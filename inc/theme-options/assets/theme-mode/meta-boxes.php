...
function lerp_page_options()
{
	...
	*/
	...
	$specific_body_background = array(
		...
		'desc' => esc_html__('Specify the HTML body background color and media. The background is visible if you have Content > Background Color set to transparent or a Boxed layout.', 'lerp') ,
		'type' => 'background',
	...
	$header_fields = array(
		...
		run_array_mb($header_scroll_opacity, '_lerp_header_type:is(header_basic),_lerp_header_type:is(header_lerpblock)') ,
	...
	$fp_opacity = array(
		...
		'type' => 'on-off',
		'desc' => esc_html__('Add opacity effect during the transition. NB. In complex page layouts this option can slow down your transitions.', 'lerp') ,
		'std' => 'off',
	);
	...
	$scroll_safe_padding = array(
		...
		'type' => 'on-off',
		'desc' => esc_html__('With the menu transparent add the menu height, when you don’t customise the row padding, as padding to your contents to avoid overlapping with the menu itself.', 'lerp') ,
		'std' => 'on',
	);
