...
<footer id="footer" class="bg-black gray8 semibold md-py font-13">
    <div class="container-sm t-center">
        <p>
            Copyright © 2018 <a href="https://maxsey.com" target="_blank"
                                class="colored underline-hover"><?php echo get_bloginfo(); ?></a>
        </p>
        <p>
            Theme <a href="https://maxsey.com" target="_blank" class="colored underline-hover">Lerp</a>. Design by <a
                    href="https://maxsey.com">Maxsey</a>
        </p>
    </div>
</footer>
<!-- END FOOTER -->
...
<!-- Contact us button -->
<a href="#" class="drop-msg click-effect dark-effect"><i class="fa fa-warning"></i></a>
<!-- Back To Top -->
